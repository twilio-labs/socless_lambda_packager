...
import { command, run, string, 
// number,
positional, option, optional, } from 'cmd-ts';
import { makePackages, defaultPackagingArgs, } from '../lib/index.js';
var PackagingCmdArgs = {
    ...
    useDocker: option({
        type: __assign(__assign({}, string), { defaultValue: function () { return defaultPackagingArgs.useDocker; }, defaultValueIsSerializable: true }),
        long: 'useDocker',
        short: 'u',
        description: "'no-linux' or 'true' or 'false'"
    }),
    language: option({
        type: __assign(__assign({}, string), { defaultValue: function () { return defaultPackagingArgs.language; }, defaultValueIsSerializable: true }),
        long: 'language',
        short: 'l',
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, run(myCmd, process.argv.slice(2))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
